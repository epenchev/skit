...
Stream* StreamFactory::CreateStream(const char* sourceClassID, const char* filterClassID, const char* sinkClassID)
{
    ...
    StreamSource* source = dynamic_cast<StreamSource*>(CreateStreamItem(sourceClassID));
    StreamSink* sink = dynamic_cast<StreamSink*>(CreateStreamItem(sinkClassID));
...
Stream* StreamFactory::CreateStream(Stream& s, const char* sourceClassID, const char* filterClassID, const char* sinkClassID)
{
    ...
    StreamSource* source = (
                             sourceClassID != NULL ?
                             dynamic_cast<StreamSource*>(CreateStreamItem(sourceClassID))
                             : s.GetSource()
                            );
    StreamSink* sink = dynamic_cast<StreamSink*>(CreateStreamItem(sinkClassID));
